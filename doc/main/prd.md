...
- **参考风格 (Reference Style)**
  - 整体交互和信息密度参考国内主流理财类 App，优先对标天天基金手机版、雪球手机版的持仓与行情页面。
  - 在保持数据密度的前提下，兼顾移动端单手操作习惯和首屏可读性，适配中英文界面文字长度差异。
